...
/*
        public List<InputProfile> defaultProfilesReplace()
        {
            return new List<InputProfile>() { InputProfile.core.Get("MPPlayer1"), InputProfile.core.Get("MPPlayer2"), InputProfile.core.Get("MPPlayer3"), InputProfile.core.Get("MPPlayer4") };
        }
*/
    }
}