...
{
    public class NMChangeSlots8Player : NMEvent
    {
        public byte slot1;
        public byte slot2;
        public byte slot3;
        ...
        public NMChangeSlots8Player()
        {
        }

        public NMChangeSlots8Player(byte varslot1, byte varslot2, byte varslot3, byte varslot4, byte varslot5, byte varslot6, byte varslot7, byte varslot8)
        {
            slot1 = varslot1;
            slot2 = varslot2;
            slot3 = varslot3;
